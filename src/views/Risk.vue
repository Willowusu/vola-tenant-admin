<template>
  ...
  export default defineComponent({
    ...
    return {
      ...
      yourMenuListData: [
        { name: "Flagged", url: "/transactions" },
        { name: "Blocked Users", url: "/live-transactions" },
        { name: "Monitored Users", url: "/live-transactions" },
        { name: "Pin Locked Users", url: "/live-transactions" },
        { name: "Blacklist", url: "/live-transactions" },
        { name: "Exempt Users", url: "/live-transactions" },
        { name: "Status Logs", url: "/live-transactions" },
        { name: "OFAC Query", url: "/live-transactions" },
      ],
    };
  },
    setup() {
