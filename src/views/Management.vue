<template>
  <div class="d-flex flex-column flex-xl-row">
    ...
    <SideMenu :menuList="yourMenuListData"></SideMenu>
                ...
                <ul class="nav nav-stretch fs-5 fw-semobold nav-line-tabs nav-line-tabs-2x border-transparent"
                  ...
                  <li class="nav-item" role="presentation">
                    <a id="kt_referrals_year_tab" class="nav-link text-active-primary active" data-bs-toggle="tab"
                      role="tab" href="#kt_customer_details_invoices_1">
                      This Year
                    </a>
                  </li>
                  ...
                  <li class="nav-item" role="presentation">
                    <a id="kt_referrals_2019_tab" class="nav-link text-active-primary ms-3" data-bs-toggle="tab"
                      role="tab" href="#kt_customer_details_invoices_2">
                      2020
                    </a>
                  </li>
                  ...
                  <li class="nav-item" role="presentation">
                    <a id="kt_referrals_2018_tab" class="nav-link text-active-primary ms-3" data-bs-toggle="tab"
                      role="tab" href="#kt_customer_details_invoices_3">
                      2019
                    </a>
                  </li>
                  ...
                  <li class="nav-item" role="presentation">
                    <a id="kt_referrals_2017_tab" class="nav-link text-active-primary ms-3" data-bs-toggle="tab"
                      role="tab" href="#kt_customer_details_invoices_4">
                      2018
                    </a>
                  </li>
                </ul>
            ...
            <div class="card-body pt-0">
              ...
              <div id="kt_referred_users_tab_content" class="tab-content">
                ...
                <div id="kt_customer_details_invoices_2" class="py-0 tab-pane fade" role="tabpanel">
                  <Datatable :header="tableHeader" :data="tableData2" :items-per-page="5"
                    :items-per-page-dropdown-enabled="false">
                    <template v-slot:order="{ row: invoice }">
                      {{ invoice.order }}
                    </template>
                ...
                <div id="kt_customer_details_invoices_3" class="py-0 tab-pane fade" role="tabpanel">
                  <Datatable :header="tableHeader" :data="tableData3" :items-per-page="5"
                    :items-per-page-dropdown-enabled="false">
                    <template v-slot:order="{ row: invoice }">
                      {{ invoice.order }}
                    </template>
                ...
                <div id="kt_customer_details_invoices_4" class="py-0 tab-pane fade" role="tabpanel">
                  <Datatable :header="tableHeader" :data="tableData4" :items-per-page="5"
                    :items-per-page-dropdown-enabled="false">
                    <template v-slot:order="{ row: invoice }">
                      {{ invoice.order }}
                    </template>
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      yourMenuListData: [
        { name: "Users", url: "/transactions" },
        { name: "Businesses", url: "/live-transactions" },
        { name: "Recipients", url: "/live-transactions" },
        { name: "Recipient Users", url: "/live-transactions" },
        { name: "Referrors", url: "/live-transactions" },
        { name: "Referror Payments", url: "/live-transactions" },
        { name: "Rewards", url: "/live-transactions" },
      ],
    };
  },
  setup() {
