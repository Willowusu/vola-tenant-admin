<template>
  ...
  export default defineComponent({
    ...
    return {
      ...
      yourMenuListData: [
        { name: "Charges", url: "/transactions" },
        { name: "Rates", url: "/transactions" },
        { name: "Threshold Limit", url: "/transactions" },
        { name: "Risk Score", url: "/transactions" },
        { name: "App  Version", url: "/transactions" },
        { name: "Payment Gateways", url: "/transactions" },
        { name: "Payout Partners", url: "/transactions" },
        { name: "Mailers", url: "/transactions" },
        { name: "Countries", url: "/transactions" },
        { name: "User Management", url: "/transactions" },
        { name: "Risk Checks", url: "/transactions" },
        { name: "Logs", url: "/transactions" },
      ],
    };
  },
    setup() {
